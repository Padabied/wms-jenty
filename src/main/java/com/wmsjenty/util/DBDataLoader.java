...
public class DBDataLoader {
    ...
    /**
     * Начальная функция оформления прихода товара.
     * Функция необходима для сбора всей необходимой информации, после чего выполнение
     * продолжается в методе processIncome.
     * Для товаров, ранее не существовавших в таблице item выполняется операция INSERT,
